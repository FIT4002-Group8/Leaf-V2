...
SELECT
    nextval('person_id'), g_c.concept_id, EXTRACT(YEAR FROM p.date_of_birth), EXTRACT(MONTH FROM p.date_of_birth), EXTRACT(DAY FROM p.date_of_birth), null, 8552, 8552, null, null, null, null, null, null, null, null, null, null
FROM
